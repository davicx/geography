...
def download_results(basin_code):
    ...
    paginate_downloads_one(basin_result_count, 100)
    
def paginate_downloads_one(basin_result_count, max_downloads):
    ...
    for i in range(0, basin_result_count, max_downloads):
        ...
        download_results_one(min, max)
        
def download_results_one(min, max):
    print(min,max)
    time.sleep(1)
