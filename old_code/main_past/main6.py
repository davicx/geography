...
#STEP : Set Date (This will be looped over)    				
def set_date(start_date, stop_date):
    print("STEP 3: Set Date")
    ...
    driver.find_element(By.CSS_SELECTOR, ".min-val").send_keys(Keys.BACK_SPACE)
    time.sleep(2)
    driver.find_element(By.CSS_SELECTOR, ".min-val").send_keys("11/01/2008")
    time.sleep(2)
    ...
    time.sleep(2)
    driver.find_element(By.CSS_SELECTOR, ".max-val").send_keys("01/01/2009")
    time.sleep(2)

    #Click OK
    driver.find_element(By.CSS_SELECTOR, ".save").click()

    print("STEP 3: Set Date FINISHED")


#STEP 4: CHANGE Check the Basin Count and set the group results tab
def check_result_count(basin_count, basin_code):
    print("STEP 4: Check the Basin Count") 
