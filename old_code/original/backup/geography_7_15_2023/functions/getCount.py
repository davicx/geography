...
def run_search():
    ...
    for index, row in data.iterrows():
        ...
        print("START SEARCH: Starting a search for the basin " + basin_code)
...
def single_basin_search(basin_code, search_terms):
    ...
    print("The count for " + basin_code + " is " + current_count)
    time.sleep(12)
