...
#options.add_argument("download.default_directory=/Users/david/Desktop/David/www/geography/downloads")
...
#Make a run function that does 5 at a time
#Get result count ahead of time?
...
def main():
    if logged_in == False:
        ...
        second_level_search()
        get_result_count()
        #download_results_one()
        download_results_two()
