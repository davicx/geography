...
#STEP 3: Download Excel Results (Up to 1000)
def download_results_one_excel(basin_code, basin_result_count):
    ...
    # /Users/david/Desktop/David/www/geography/data/singleBasinToDo/excel 
    excelData = pd.read_csv('data/singleBasinToDo/excel/' + basin_code + '.csv')
    ...
    for index, row in excelData.iterrows():
        ...
        print(basin_code, min, max, finished)
        time.sleep(1)
